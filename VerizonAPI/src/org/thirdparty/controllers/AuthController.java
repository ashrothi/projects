...
public class AuthController {
	...
	/**
	 * This API is used to Authenticate the user.User Needs to Pass user_name
	 * and password
	 * 
	 * @param user_name
	 * @param password
	...
	public ResponseEntity<?> deviceRegister(@RequestParam String user_name, @RequestParam String password,
