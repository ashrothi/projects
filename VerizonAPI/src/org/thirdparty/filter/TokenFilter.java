...
public class TokenFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
		...
		response.setHeader("Access-Control-Allow-Headers",
				"Content-Type, Access-Control-Allow-Headers, Authorization, X-Requested-With,user_name,password");
		/**
		 * To Bypass the API url from Authentication
		 */
		if (URI.equals("/") || URI.equals("/swagger-ui.html") || URI.equals("/notifications/SIMActivated")
				|| URI.equals("/subscriber/auth/token") || URI.equals("/push/notification") || URI.equals("/onboarding")
				|| URI.equals("/activateSIM") || URI.contains("/webjars/springfox") || URI.contains("/images")
			...
			/**
			 * To Access the functionality of the OrchestrationGenericProcess
			...
			if (map.get("user_name") == null && map.get("password") == null) {
				...
				try {
					 ...
					 */
					System.out.println(" responseMessage.getBody() " + responseMessage.getBody());
