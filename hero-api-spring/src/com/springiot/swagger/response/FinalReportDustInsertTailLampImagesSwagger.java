...
/**
 * 
 * This class contains response on /final/report/dust/insert/tail/lamp/images API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FinalReportDustInsertTailLampImagesSwagger {
...
/**
	...
	private List<FinalReportDustInsertTailLampImages> object;

	/**
	 * @return the object
	 */
	public List<FinalReportDustInsertTailLampImages> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FinalReportDustInsertTailLampImages> object) {
		this.object = object;
	}
...
*/
class FinalReportDustInsertTailLampImages {
