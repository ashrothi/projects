...
/**
 * 
 * This class contains response on /final/report/get/relay/data API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FinalReportGetRelayDataSwagger {
...
/**
	...
	private List<FinalReportGetRelayData> object;

	/**
	 * @return the object
	 */
	public List<FinalReportGetRelayData> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FinalReportGetRelayData> object) {
		this.object = object;
	}
