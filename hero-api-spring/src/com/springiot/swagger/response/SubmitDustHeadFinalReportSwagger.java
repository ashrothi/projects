 ...
 *
 */
public class SubmitDustHeadFinalReportSwagger {
...
/**
	...
	private List<SubmitDustHeadFinalReport> object;

	/**
	 * @return the object
	 */
	public List<SubmitDustHeadFinalReport> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<SubmitDustHeadFinalReport> object) {
		this.object = object;
	}
...
*/
class SubmitDustHeadFinalReport {
	private String file;
