...
/**
 * 
 * This class contains response on /hero/final/report/shower/get/tail/lamp/result API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class HeroFinalReportShowerGetTailLampResultSwagger {
...
/**
	...
	private List<HeroFinalReportShowerGetTailLampResult> object;

	/**
	 * @return the object
	 */
	public List<HeroFinalReportShowerGetTailLampResult> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<HeroFinalReportShowerGetTailLampResult> object) {
		this.object = object;
	}
...
*/
class HeroFinalReportShowerGetTailLampResult {
	private int id; 
