...
/**
 * 
 * This class contains response on /final/report/get/side/stand/data API
 * response
 * 
 * 
 ...
 *
 */
public class FinalReportGetSideStandDataSwagger {
	...
	private List<FinalReportGetSideStandData> object;

	/**
	 * @return the object
	 */
	public List<FinalReportGetSideStandData> getObject() {
		return object;
	}
	 ...
	 * @param object
	 */
	public void setObject(List<FinalReportGetSideStandData> object) {
		this.object = object;
	}
 ...
 */
class FinalReportGetSideStandData {
	private int id;
	...
	private String inspection_lot_date;
	private String hmcl_part_code;
	private String vendor_part_code;
	private String vendor_mfg_location;
	private String inspection_lot_qty;
	private String part_mfg_date;
	...
	/**
	 * @param inspection_lot_no
	 *            the inspection_lot_no to set
	 */
	 ...
	 */
	public String getInspection_lot_date() {
		return inspection_lot_date;
	}

	/**
	 * @param inspection_lot_date
	 *            the inspection_lot_date to set
	 */
	public void setInspection_lot_date(String inspection_lot_date) {
	...
	/**
	 * @param hmcl_part_code
	 *            the hmcl_part_code to set
	 */
	...
	/**
	 * @param vendor_part_code
	 *            the vendor_part_code to set
	 */
	...
	/**
	 * @param vendor_mfg_location
	 *            the vendor_mfg_location to set
	 */
	 ...
	 */
	public String getInspection_lot_qty() {
		return inspection_lot_qty;
	}

	/**
	 * @param inspection_lot_qty
	 *            the inspection_lot_qty to set
	 */
	public void setInspection_lot_qty(String inspection_lot_qty) {
	 ...
	 */
	public String getPart_mfg_date() {
		return part_mfg_date;
	}

	/**
	 * @param part_mfg_date
	 *            the part_mfg_date to set
	 */
	public void setPart_mfg_date(String part_mfg_date) {
	...
	/**
	 * @param modification_details
	 *            the modification_details to set
	 */
	...
	/**
	 * @param test_condition_and_methord
	 *            the test_condition_and_methord to set
	 */
	 ...
	 */
	public String getIs_succesful() {
		return is_succesful;
	}

	/**
	 * @param is_succesful
	 *            the is_succesful to set
	 */
	public void setIs_succesful(String is_succesful) {
