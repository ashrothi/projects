...
/**
 * 
 * This class contains response on /final/report/dust/get/head/lamp/result API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FinalReportDustGetHeadLampResultSwagger {
...
/**
	...
	private List<FinalReportDustGetHeadLampResult> object;

	/**
	 * @return the object
	 */
	public List<FinalReportDustGetHeadLampResult> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FinalReportDustGetHeadLampResult> object) {
		this.object = object;
	}
...
*/
class FinalReportDustGetHeadLampResult {
	private int id; 
