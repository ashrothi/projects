...
/**
 * 
 * This class contains response on /final/report/shower/insert/head/lamp/images API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FinalReportShowerInsertHeadLampImagesSwagger {
...
/**
	...
	private List<FinalReportShowerInsertHeadLampImages> object;

	/**
	 * @return the object
	 */
	public List<FinalReportShowerInsertHeadLampImages> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FinalReportShowerInsertHeadLampImages> object) {
		this.object = object;
	}
...
*/
class FinalReportShowerInsertHeadLampImages {
	private int id; 
