...
/**
 * 
 * This class contains response on /hero/final/report/shower/get/front/winker API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class HeroFinalReportShowerGetFrontWinkerSwagger {
...
/**
	...
	private List<HeroFinalReportShowerGetFrontWinker> object;

	/**
	 * @return the object
	 */
	public List<HeroFinalReportShowerGetFrontWinker> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<HeroFinalReportShowerGetFrontWinker> object) {
		this.object = object;
	}
...
*/
class HeroFinalReportShowerGetFrontWinker {
	private int id; 
