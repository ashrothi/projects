...
/**
 * 
 * This class contains response on /final/report/shower/get/head/lamp/result API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FinalReportShowerGetHeadLampResultSwagger {
...
/**
	...
	private List<FinalReportShowerGetHeadLampResult> object;

	/**
	 * @return the object
	 */
	public List<FinalReportShowerGetHeadLampResult> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FinalReportShowerGetHeadLampResult> object) {
		this.object = object;
	}
...
*/
class FinalReportShowerGetHeadLampResult {
