...
/**
 * 
 * This class contains response on /component/get/settings/by/id API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class ComponentGetSettingsByIdSwagger {
...
/**
	...
	private List<ComponentGetSettingsById> object;

	/**
	 * @return the object
	 */
	public List<ComponentGetSettingsById> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<ComponentGetSettingsById> object) {
		this.object = object;
	}
...
*/
class ComponentGetSettingsById {
	private int id;
	...
	/**
	 * @return the is_updatable
	 */
	public int getIs_updatable() {
		return is_updatable;
	}
	/**
	 * @param is_updatable the is_updatable to set
	 */
	public void setIs_updatable(int is_updatable) {
