...
/**
 * 
 * This class contains response on /hero/final/report/get/relay/result API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class HeroFinalReportGetRelayResultSwagger {
...
/**
	...
	private List<HeroFinalReportGetRelayResult> object;

	/**
	 * @return the object
	 */
	public List<HeroFinalReportGetRelayResult> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<HeroFinalReportGetRelayResult> object) {
		this.object = object;
	}
...
*/
class HeroFinalReportGetRelayResult {
	private int id; 
