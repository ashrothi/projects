...
import com.springiot.swagger.response.HeroFinalReportInsertHornSignatureSwagger;
import com.springiot.swagger.response.HeroFinalReportInsertRelayImagesSwagger;
import com.springiot.swagger.response.HeroFinalReportInsertRelayResultSwagger;
import com.springiot.swagger.response.HeroFinalReportShowerGetRearWinkerResultSwagger;
import com.springiot.swagger.response.HeroFinalReportShowerGetRearWinkerSignatureSwagger;
import com.springiot.swagger.response.HeroFinalReportUpdateRelayFinalSubmitSwagger;
import com.springiot.swagger.response.HeroFinalReportUpdateRelayHeaderSwagger;
...
public class DustWinkerController {
	 ...
	 * @return Return the response message.
	 */
	@ApiOperation(value = "/hero/final/report/dust/get/winker/front/testing/Version", notes = "To get Testing Version in Front Winker Final Report", response = HeroFinalReportShowerGetRearWinkerResultSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message.
	 */
	@ApiOperation(value = "/hero/final/report/dust/get/winker/front/vendor", notes = "To get Vendor Code in Front Winker Final Report.", response = HeroFinalReportShowerGetRearWinkerSignatureSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message.
	 */
	@ApiOperation(value = "/hero/final/report/dust/insert/winker/front/result", notes = "To insert Result in Front Winker Final Report.", response = HeroFinalReportInsertRelayResultSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message.
	 */
	@ApiOperation(value = "/hero/final/report/dust/insert/winker/front/signature", notes = "To insert Signature in Front Winker Final Report", response = HeroFinalReportInsertHornSignatureSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message.
	 */
	@ApiOperation(value = "/hero/final/report/dust/update/winker/front", notes = "To to update Front Winker Final Report.", response = HeroFinalReportUpdateRelayFinalSubmitSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message.
	 */
	@ApiOperation(value = "/hero/final/report/dust/update/winker/front/final/submit", notes = "To Update final submit in Front Winker Final Report.", response = HeroFinalReportUpdateRelayFinalSubmitSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message.
	 */
	@ApiOperation(value = "/hero/final/report/dust/update/winker/front/header", notes = "To to update header in Front Winker Final Report.", response = HeroFinalReportUpdateRelayHeaderSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message.
	 */
	@ApiOperation(value = "/hero/final/report/dust/winker/front/final/submit", notes = "To Submit Final Report of Front Winker.", response = HeroFinalReportUpdateRelayFinalSubmitSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message.
	 */
	@ApiOperation(value = "/hero/final/report/dust/get/winker/rear/testing/Version", notes = "To get Testing Version in Rear Winker Final Report", response = HeroFinalReportShowerGetRearWinkerResultSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message.
	 */
	@ApiOperation(value = "/hero/final/report/dust/get/winker/rear/vendor", notes = "To get Vendor code in Rear Winker Final Report", response = HeroFinalReportShowerGetRearWinkerSignatureSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message.
	 */
	@ApiOperation(value = "/hero/final/report/dust/insert/winker/rear/result", notes = "To Insert Result in Rear Winker Final Report", response = HeroFinalReportInsertRelayResultSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message.
	 */
	@ApiOperation(value = "/hero/final/report/dust/insert/winker/rear/signature", notes = "To Insert Signature in Rear Winker Final Report", response = HeroFinalReportInsertHornSignatureSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	...
	public @ResponseBody Message heroFinalReportDustInsertWinkerRearSignature(
			@ApiIgnore @RequestParam Map<String, String> map) {
		Message message = genericProcess.GenericProcedureCalling("410", map, null);
		return message;
	}
	 ...
	 * @return Return the response message.
	 */
	@ApiOperation(value = "/hero/final/report/dust/update/winker/rear", notes = "To Update Rear Winker Final Report.", response = HeroFinalReportUpdateRelayFinalSubmitSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	...
	public @ResponseBody Message heroFinalReportDustUpdateWinkerRear(
			@ApiIgnore @RequestParam Map<String, String> map) {
		Message message = genericProcess.GenericProcedureCalling("411", map, null);
		return message;
	}
	 ...
	 * @return Return the response message.
	 */
	@ApiOperation(value = "/hero/final/report/dust/update/winker/rear/final/submit", notes = "To Update Final Submit in Rear Winker Final Report.", response = HeroFinalReportUpdateRelayFinalSubmitSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	...
	public @ResponseBody Message heroFinalReportDustUpdateWinkerRearFinalSubmit(
			@ApiIgnore @RequestParam Map<String, String> map) {
		Message message = genericProcess.GenericProcedureCalling("412", map, null);
		return message;
	}
	 ...
	 * @return Return the response message.
	 */
	@ApiOperation(value = "/hero/final/report/dust/update/winker/rear/header", notes = "To Update Header in Rear Winker Final Report.", response = HeroFinalReportUpdateRelayHeaderSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	...
	public @ResponseBody Message heroFinalReportDustUpdateWinkerRearHeader(
			@ApiIgnore @RequestParam Map<String, String> map) {
		Message message = genericProcess.GenericProcedureCalling("413", map, null);
		return message;
	}
	 ...
	 * @return Return the response message.
	 */
	@ApiOperation(value = "/hero/final/report/dust/winker/rear/final/submit", notes = "To Submit Final Report of Rear Winker.", response = HeroFinalReportUpdateRelayFinalSubmitSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	...
	public @ResponseBody Message heroFinalReportDustWinkerRearFinalSubmit(
			@ApiIgnore @RequestParam Map<String, String> map) {
		Message message = genericProcess.GenericProcedureCalling("414", map, null);
		return message;
	}
	...
	public @ResponseBody Message heroFinalReportDustWinkerRearDeleteImages(
			@ApiIgnore @RequestParam Map<String, String> map) {
		Message message = genericProcess.GenericProcedureCalling("415", map, null);
		return message;
	}
	...
	public @ResponseBody Message heroFinalReportDustWinkerRearDeleteObservation(
			@ApiIgnore @RequestParam Map<String, String> map) {
		Message message = genericProcess.GenericProcedureCalling("416", map, null);
		return message;
	}
}
