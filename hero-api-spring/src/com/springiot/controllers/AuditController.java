...
import com.springiot.swagger.response.AuditLogGetAllLimitSwagger;
import com.springiot.swagger.response.AuditLogGetAllSwagger;
...
public class AuditController {
	 ...
	 */
	@ApiOperation(value = "/audit/log/get/all", notes = "Returns all the logs for the specific application", response = AuditLogGetAllSwagger.class)
	@ApiImplicitParams({
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/audit/log/get/all/limit", notes = "Helps to get logs of the user for the particular limit", response = AuditLogGetAllLimitSwagger.class)
	@ApiImplicitParams({
			@ApiImplicitParam(name = "token", value = "Token is generated to access API", required = true, access = "query", paramType = "query"),
			@ApiImplicitParam(name = "userkey", value = "Requires the UserKey of User", required = true, access = "query", paramType = "query"),
			@ApiImplicitParam(name = "user_id", value = "Requires User Id of user", required = true, access = "query", paramType = "query"),
