...
import com.springiot.swagger.response.DownloadDailyHornReportEscalationSwagger;
import com.springiot.swagger.response.DownloadDailyRelayReportEscalationSwagger;
import com.springiot.swagger.response.DownloadDailySideStandReportEscalationSwagger;
import com.springiot.swagger.response.DownloadPlannerReportEscalationSwagger;
...
public class EscalationDownload {
	 ...
	 */
	@ApiOperation(value = "/download/daily/horn/report/Escalation", notes = "To Send Downloaded File Of Daily Report Of Horn with Escalation",response=DownloadDailyHornReportEscalationSwagger.class)
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/download/daily/relay/report/Escalation", notes = "To Send Downloaded File Of Daily Report Of Relay with Escalation",response=DownloadDailyRelayReportEscalationSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/download/daily/side/stand/report/Escalation", notes = "To send  Downloaded File Of Daily Report Of Side Stand with Escalation",response=DownloadDailySideStandReportEscalationSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/download/planner/report/Escalation", notes = "To send Downloaded File Of Daily Report Of Planner with Escalation",response=DownloadPlannerReportEscalationSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
