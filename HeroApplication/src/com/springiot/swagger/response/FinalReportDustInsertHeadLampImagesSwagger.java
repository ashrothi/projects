...
/**
 * 
 * This class contains response on /final/report/dust/insert/head/lamp/images API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FinalReportDustInsertHeadLampImagesSwagger {
...
/**
	...
	private List<FinalReportDustInsertHeadLampImages> object;

	/**
	 * @return the object
	 */
	public List<FinalReportDustInsertHeadLampImages> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FinalReportDustInsertHeadLampImages> object) {
		this.object = object;
	}
...
*/
class FinalReportDustInsertHeadLampImages {
	private int id; 
