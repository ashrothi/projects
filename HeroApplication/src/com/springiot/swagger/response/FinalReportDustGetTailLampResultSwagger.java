...
/**
 * 
 * This class contains response on /final/report/dust/get/tail/lamp/result API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FinalReportDustGetTailLampResultSwagger {
...
/**
	...
	private List<FinalReportDustGetTailLampResult> object;

	/**
	 * @return the object
	 */
	public List<FinalReportDustGetTailLampResult> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FinalReportDustGetTailLampResult> object) {
		this.object = object;
	}
...
*/
class FinalReportDustGetTailLampResult {
	private int id; 
