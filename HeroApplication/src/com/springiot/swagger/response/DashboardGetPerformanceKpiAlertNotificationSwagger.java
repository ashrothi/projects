...
/**
 * 
 * This class contains response on /dashboard/get/performance/kpi/alert/notification API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class DashboardGetPerformanceKpiAlertNotificationSwagger {
...
/**
	...
	private List<DashboardGetPerformanceKpiAlertNotification> object;

	/**
	 * @return the object
	 */
	public List<DashboardGetPerformanceKpiAlertNotification> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<DashboardGetPerformanceKpiAlertNotification> object) {
		this.object = object;
	}
...
*/
class DashboardGetPerformanceKpiAlertNotification {
