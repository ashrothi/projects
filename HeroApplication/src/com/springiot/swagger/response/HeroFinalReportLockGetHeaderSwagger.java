...
/**
 * 
 * This class contains response on /hero/final/report/lock/get/header API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class HeroFinalReportLockGetHeaderSwagger {
...
/**
	...
	private List<HeroFinalReportLockGetHeader> object;

	/**
	 * @return the object
	 */
	public List<HeroFinalReportLockGetHeader> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<HeroFinalReportLockGetHeader> object) {
		this.object = object;
	}
...
*/
class HeroFinalReportLockGetHeader {
	private int id; 
	...
	/**
	 * @return the nature_of_test
	 */
	public String getNature_of_test() {
		return nature_of_test;
	}
	/**
	 * @param nature_of_test the nature_of_test to set
	 */
