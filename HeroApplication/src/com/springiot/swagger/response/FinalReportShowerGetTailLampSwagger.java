...
/**
 * 
 * This class contains response on /final/report/shower/get/tail/lamp API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FinalReportShowerGetTailLampSwagger {
...
/**
	...
	private List<FinalReportShowerGetTailLamp> object;

	/**
	 * @return the object
	 */
	public List<FinalReportShowerGetTailLamp> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FinalReportShowerGetTailLamp> object) {
		this.object = object;
	}
...
*/
class FinalReportShowerGetTailLamp {
	private int id; 
