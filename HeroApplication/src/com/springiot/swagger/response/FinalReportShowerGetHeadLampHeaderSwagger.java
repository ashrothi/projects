...
/**
 * 
 * This class contains response on /final/report/shower/get/head/lamp/header API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FinalReportShowerGetHeadLampHeaderSwagger {
...
/**
	...
	private List<FinalReportShowerGetHeadLampHeader> object;

	/**
	 * @return the object
	 */
	public List<FinalReportShowerGetHeadLampHeader> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FinalReportShowerGetHeadLampHeader> object) {
		this.object = object;
	}
...
*/
class FinalReportShowerGetHeadLampHeader {
	private int id; 
