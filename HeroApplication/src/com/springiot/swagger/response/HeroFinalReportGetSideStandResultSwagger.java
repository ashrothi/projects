...
/**
 * 
 * This class contains response on /hero/final/report/get/side/stand/result API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class HeroFinalReportGetSideStandResultSwagger {
...
/**
	...
	private List<HeroFinalReportGetSideStandResult> object;

	/**
	 * @return the object
	 */
	public List<HeroFinalReportGetSideStandResult> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<HeroFinalReportGetSideStandResult> object) {
		this.object = object;
	}
...
*/
class HeroFinalReportGetSideStandResult {
	private int id; 
