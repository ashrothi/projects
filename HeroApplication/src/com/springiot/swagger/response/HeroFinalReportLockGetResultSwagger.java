...
/**
 * 
 * This class contains response on /hero/final/report/lock/get/result API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class HeroFinalReportLockGetResultSwagger {
...
/**
	...
	private List<HeroFinalReportLockGetResult> object;

	/**
	 * @return the object
	 */
	public List<HeroFinalReportLockGetResult> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<HeroFinalReportLockGetResult> object) {
		this.object = object;
	}
...
*/
class HeroFinalReportLockGetResult {
	private int id; 
