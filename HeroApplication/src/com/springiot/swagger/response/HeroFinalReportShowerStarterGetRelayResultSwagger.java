...
/**
 * 
 * This class contains response on /hero/final/report/shower/starter/get/relay/result API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class HeroFinalReportShowerStarterGetRelayResultSwagger {
...
/**
	...
	private List<HeroFinalReportShowerStarterGetRelayResult> object;

	/**
	 * @return the object
	 */
	public List<HeroFinalReportShowerStarterGetRelayResult> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<HeroFinalReportShowerStarterGetRelayResult> object) {
		this.object = object;
	}
...
*/
class HeroFinalReportShowerStarterGetRelayResult {
	private int id; 
