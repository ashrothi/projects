...
/**
 * 
 * This class contains response on /final/report/dust/get/head/lamp API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FinalReportDustGetHeadLampSwagger {
...
/**
	...
	private List<FinalReportDustGetHeadLamp> object;

	/**
	 * @return the object
	 */
	public List<FinalReportDustGetHeadLamp> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FinalReportDustGetHeadLamp> object) {
		this.object = object;
	}
...
*/
class FinalReportDustGetHeadLamp {
	private int id; 
