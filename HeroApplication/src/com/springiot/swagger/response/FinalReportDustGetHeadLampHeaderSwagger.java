...
/**
 * 
 * This class contains response on /final/report/dust/get/head/lamp/header API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FinalReportDustGetHeadLampHeaderSwagger {
...
/**
	...
	private List<FinalReportDustGetHeadLampHeader> object;

	/**
	 * @return the object
	 */
	public List<FinalReportDustGetHeadLampHeader> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FinalReportDustGetHeadLampHeader> object) {
		this.object = object;
	}
...
*/
class FinalReportDustGetHeadLampHeader {
	private int id; 
