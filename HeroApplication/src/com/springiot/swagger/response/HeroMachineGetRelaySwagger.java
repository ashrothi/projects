...
/**
 * 
 * This class contains response on /hero/machine/get/relay API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class HeroMachineGetRelaySwagger {
...
/**
	...
	private List<HeroMachineGetRelay> object;

	/**
	 * @return the object
	 */
	public List<HeroMachineGetRelay> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<HeroMachineGetRelay> object) {
		this.object = object;
	}
