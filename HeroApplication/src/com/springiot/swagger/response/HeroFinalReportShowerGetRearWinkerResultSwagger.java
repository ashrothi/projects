...
/**
 * 
 * This class contains response on /hero/final/report/shower/get/rear/winker/result API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class HeroFinalReportShowerGetRearWinkerResultSwagger {
...
/**
	...
	private List<HeroFinalReportShowerGetRearWinkerResult> object;

	/**
	 * @return the object
	 */
	public List<HeroFinalReportShowerGetRearWinkerResult> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<HeroFinalReportShowerGetRearWinkerResult> object) {
		this.object = object;
	}
...
*/
class HeroFinalReportShowerGetRearWinkerResult {
	private int id; 
