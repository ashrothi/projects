	...
	public Message getAPIsMappingClass() throws Exception {
		...
		try {
			...
			for (RequestMappingInfo mappingInfo : map.keySet()) {
				...
				String responsedata = templateReport.TemplateReportFile("template/swagger.vm", templateMap);

				String path = "/home/tanvigarg/Documents/eclipse-workspace/ThirdPartyWFMApplication/src/com/springiot/swagger/response"
