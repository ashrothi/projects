...
/**
 * 
 * This class contains response on /thirdparty/integration/token API response
 * 
 * 
 * @author tanvigarg
 *
 */
public class ThirdPartyIntegrationTokenSwagger {
	...
	private List<ThirdpartyIntegrationToken> object;

	/**
	 * @return the object
	 */
	public List<ThirdpartyIntegrationToken> getObject() {
		return object;
	}
	 ...
	 * @param object
	 */
	public void setObject(List<ThirdpartyIntegrationToken> object) {
		this.object = object;
	}
 ...
 */
class ThirdpartyIntegrationToken {
