...
/**
 * 
 * This class contains response on /hero/final/report/shower/starter/get/relay/header API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class HeroFinalReportShowerStarterGetRelayHeaderSwagger {
...
/**
	...
	private List<HeroFinalReportShowerStarterGetRelayHeader> object;

	/**
	 * @return the object
	 */
	public List<HeroFinalReportShowerStarterGetRelayHeader> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<HeroFinalReportShowerStarterGetRelayHeader> object) {
		this.object = object;
	}
...
*/
class HeroFinalReportShowerStarterGetRelayHeader {
	private int id; 
	...
	/**
	 * @return the test_condition
	 */
	public String getTest_condition() {
		return test_condition;
	}
	/**
	 * @param test_condition the test_condition to set
	 */
	...
	/**
	 * @return the test_method
	 */
	public String getTest_method() {
		return test_method;
	}
	/**
	 * @param test_method the test_method to set
	 */
