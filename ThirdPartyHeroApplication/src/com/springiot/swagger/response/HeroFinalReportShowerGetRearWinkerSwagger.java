...
/**
 * 
 * This class contains response on /hero/final/report/shower/get/rear/winker API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class HeroFinalReportShowerGetRearWinkerSwagger {
...
/**
	...
	private List<HeroFinalReportShowerGetRearWinker> object;

	/**
	 * @return the object
	 */
	public List<HeroFinalReportShowerGetRearWinker> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<HeroFinalReportShowerGetRearWinker> object) {
		this.object = object;
	}
...
*/
class HeroFinalReportShowerGetRearWinker {
	private int id; 
