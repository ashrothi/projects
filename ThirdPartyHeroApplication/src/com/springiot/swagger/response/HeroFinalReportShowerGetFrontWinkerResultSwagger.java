...
/**
 * 
 * This class contains response on /hero/final/report/shower/get/front/winker/result API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class HeroFinalReportShowerGetFrontWinkerResultSwagger {
...
/**
	...
	private List<HeroFinalReportShowerGetFrontWinkerResult> object;

	/**
	 * @return the object
	 */
	public List<HeroFinalReportShowerGetFrontWinkerResult> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<HeroFinalReportShowerGetFrontWinkerResult> object) {
		this.object = object;
	}
...
*/
class HeroFinalReportShowerGetFrontWinkerResult {
	private int id; 
