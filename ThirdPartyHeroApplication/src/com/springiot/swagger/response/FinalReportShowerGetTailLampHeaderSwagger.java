...
/**
 * 
 * This class contains response on /final/report/shower/get/tail/lamp/header API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FinalReportShowerGetTailLampHeaderSwagger {
...
/**
	...
	private List<FinalReportShowerGetTailLampHeader> object;

	/**
	 * @return the object
	 */
	public List<FinalReportShowerGetTailLampHeader> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FinalReportShowerGetTailLampHeader> object) {
		this.object = object;
	}
...
*/
class FinalReportShowerGetTailLampHeader {
