...
/**
 * 
 * This class contains response on /machine/get/side/stand API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class MachineGetSideStandSwagger {
...
/**
	...
	private List<MachineGetSideStand> object;

	/**
	 * @return the object
	 */
	public List<MachineGetSideStand> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<MachineGetSideStand> object) {
		this.object = object;
	}
