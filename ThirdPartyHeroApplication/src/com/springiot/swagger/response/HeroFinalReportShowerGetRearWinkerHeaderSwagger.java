...
/**
 * 
 * This class contains response on /hero/final/report/shower/get/rear/winker/header API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class HeroFinalReportShowerGetRearWinkerHeaderSwagger {
...
/**
	...
	private List<HeroFinalReportShowerGetRearWinkerHeader> object;

	/**
	 * @return the object
	 */
	public List<HeroFinalReportShowerGetRearWinkerHeader> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<HeroFinalReportShowerGetRearWinkerHeader> object) {
		this.object = object;
	}
...
*/
class HeroFinalReportShowerGetRearWinkerHeader {
	private int id; 
