...
/**
 * 
 * This class contains response on /final/report/horn/insert/images API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FinalReportHornInsertImagesSwagger {
...
/**
	...
	private List<FinalReportHornInsertImages> object;

	/**
	 * @return the object
	 */
	public List<FinalReportHornInsertImages> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FinalReportHornInsertImages> object) {
		this.object = object;
	}
...
*/
class FinalReportHornInsertImages {
	private int id; 
