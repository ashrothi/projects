...
/**
 * 
 * This class contains response on /final/report/dust/get/tail/lamp/header API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FinalReportDustGetTailLampHeaderSwagger {
...
/**
	...
	private List<FinalReportDustGetTailLampHeader> object;

	/**
	 * @return the object
	 */
	public List<FinalReportDustGetTailLampHeader> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FinalReportDustGetTailLampHeader> object) {
		this.object = object;
	}
...
*/
class FinalReportDustGetTailLampHeader {
	private int id; 
	...
	private String part_modification_details; 
	private String testing_condition_as_per_standard; 
	private String testing_condition_actual_test_condition; 
	 ...
	 */
	public void setTest_start_date(long test_start_date) {
	 ...
	 */
	public void setTest_end_date(long test_end_date) {
	...
	/**
	 * @return the part_modification_details
	 */
	public String getPart_modification_details() {
		return part_modification_details;
	}
	/**
	 * @param part_modification_details the part_modification_details to set
	 */
	public void setPart_modification_details(String part_modification_details) {
		this.part_modification_details = part_modification_details;
	}
	/**
	 * @return the testing_condition_as_per_standard
	 */
	public String getTesting_condition_as_per_standard() {
		return testing_condition_as_per_standard;
	}
	/**
	 * @param testing_condition_as_per_standard the testing_condition_as_per_standard to set
	 */
	public void setTesting_condition_as_per_standard(String testing_condition_as_per_standard) {
		this.testing_condition_as_per_standard = testing_condition_as_per_standard;
	}
	/**
	 * @return the testing_condition_actual_test_condition
	 */
	public String getTesting_condition_actual_test_condition() {
		return testing_condition_actual_test_condition;
	}
	/**
	 * @param testing_condition_actual_test_condition the testing_condition_actual_test_condition to set
	 */
	public void setTesting_condition_actual_test_condition(String testing_condition_actual_test_condition) {
		this.testing_condition_actual_test_condition = testing_condition_actual_test_condition;
	}
	/**
