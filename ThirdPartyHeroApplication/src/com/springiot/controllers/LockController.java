...
import com.springiot.swagger.response.GenericFinalReportDeleteImagesSwagger;
import com.springiot.swagger.response.GenericFinalReportDeleteObservationSwagger;
...
import com.springiot.swagger.response.GenericFinalReportGetTestingVersionSwagger;
...
import com.springiot.swagger.response.HeroDailyReportCountLockSwagger;
import com.springiot.swagger.response.HeroDailyReportGetLockCycleSwagger;
import com.springiot.swagger.response.HeroDailyReportGetLockHeaderSwagger;
import com.springiot.swagger.response.HeroDailyReportGetLockSwagger;
import com.springiot.swagger.response.HeroFinalReportGetLockSwagger;
import com.springiot.swagger.response.HeroFinalReportLockGetHeaderSwagger;
import com.springiot.swagger.response.HeroFinalReportLockGetImagesSwagger;
...
import com.springiot.swagger.response.HeroFinalReportLockInsertImagesSwagger;
import com.springiot.swagger.response.HeroFinalReportLockInsertSignatureSwagger;
import com.springiot.swagger.response.HeroFinalReportLockUpdateFinalSubmitSwagger;
import com.springiot.swagger.response.HeroFinalReportLockUpdateHeaderSwagger;
...
public class LockController {
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/hero/final/report/lock/get/signature", notes = "To get signature in Shower Starter Final Report",response=GenericFinalReportGetSignatureSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/hero/final/report/lock/get/testing/Version", notes = "To get Testing Version of Lock Final Report",response=GenericFinalReportGetTestingVersionSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/hero/final/report/lock/insert/result", notes = "To insert Result in Lock Final Report",response=GenericFinalReportInsertResultSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/hero/final/report/lock/delete/images", notes = "To Delete Images from Lock Final Report",response=GenericFinalReportDeleteImagesSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/hero/final/report/lock/get/result", notes = "To get result in Lock Final Report",response=GenericFinalReportGetResultSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
