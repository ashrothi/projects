...
import com.springiot.swagger.response.GetapiurlClassSwagger;
...
public class MappingHandler {
	 ...
	 */
	@ApiOperation(value = "/getapiurl", notes = "To get API URLs.",response=GetapiurlClassSwagger.class)
	@ApiImplicitParams({})
	/*
	...
	public @ResponseBody Message getapiURLClass() {
