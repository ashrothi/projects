...
public class FinalReportController {
	 ...
	 */
	@ApiOperation(value = "/submit/horn/final/report", notes = "To Submit the Final Report to Get Pdf Of Horn ",response=GenericSubmitFinalReportSwagger.class)
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/submit/shower/final/report", notes = "To Submit the Final Report to Get Pdf of Shower",response=GenericSubmitFinalReportSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/submit/relay/final/report", notes = "To Submit the Final Report to Get Pdf of Relay",response=GenericSubmitFinalReportSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/submit/side/stand/final/report", notes = "To Submit the Final Report to Get Pdf of Side Stand",response=GenericSubmitFinalReportSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/submit/dust/head/final/report", notes = "To Submit the Final Report to Get Pdf of Side Stand",response=GenericSubmitFinalReportSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/submit/dust/tail/final/report", notes = "To Submit the Final Report to Get Pdf of Side Stand",response=GenericSubmitFinalReportSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/submit/shower/head/final/report", notes = "To Submit the Final Report to Get Pdf of Shower",response=GenericSubmitFinalReportSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/submit/shower/front/winker/final/report", notes = "To Submit the Final Report to Get Pdf of Shower",response=GenericSubmitFinalReportSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/submit/shower/rear/winker/final/report", notes = "To Submit the Final Report to Get Pdf of Shower",response=GenericSubmitFinalReportSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/submit/shower/starter/relay/final/report", notes = "To Submit the Final Report to Get Pdf of Shower",response=GenericSubmitFinalReportSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/submit/lock/final/report", notes = "To Submit the Final Report to Get Pdf of Shower",response=GenericSubmitFinalReportSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/submit/shower/spedometer/final/report", notes = "To Submit the Final Report to Get .pdf of Speedometer.",response=GenericSubmitFinalReportSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/submit/dust/winker/front/final/report", notes = "To Submit the Final Report to Get .pdf of Speedometer.",response=GenericSubmitFinalReportSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message.
	 */
	@ApiOperation(value = "/submit/dust/winker/rear/final/report", notes = "To Submit the Final Report to Get .pdf of Speedometer.",response=GenericSubmitFinalReportSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
