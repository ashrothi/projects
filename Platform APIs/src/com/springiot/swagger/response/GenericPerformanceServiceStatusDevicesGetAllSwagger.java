...
/**
 * 
 * This class contains response on /performance/servicestatus/devices/get/all
 * API response
 * 
 * 
 * @author tanvigarg
 *
 */
public class GenericPerformanceServiceStatusDevicesGetAllSwagger {
	...
	private List<GenericPerformanceServiceStatusDevicesGetAll> object;

	/**
	 * @return the object
	 */
	public List<GenericPerformanceServiceStatusDevicesGetAll> getObject() {
		return object;
	}
	 ...
	 * @param object
	 */
	public void setObject(List<GenericPerformanceServiceStatusDevicesGetAll> object) {
		this.object = object;
	}
...
/**
 * Set the response parameters of /performance/servicestatus/devices/get/all
 * API.
 * 
 *
 */
class GenericPerformanceServiceStatusDevicesGetAll {
