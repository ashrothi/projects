...
/**
 * 
 * This class contains response of /dashboard/main/worst/performing/device/type
 * API response
 * 
 * 
 * @author tanvigarg
 *
 */
public class DashboardMainWorstPerformingDeviceTypeSwagger {
	...
	private List<DashboardMainWorstPerformingDeviceType> object;

	/**
	 * @return the object
	 */
	public List<DashboardMainWorstPerformingDeviceType> getObject() {
		return object;
	}
	 ...
	 * @param object
	 */
	public void setObject(List<DashboardMainWorstPerformingDeviceType> object) {
		this.object = object;
	}
...
/**
 * Set the response parameters of /dashboard/main/worst/performing/device/type
 * API.
 * 
 *
 */
class DashboardMainWorstPerformingDeviceType {
