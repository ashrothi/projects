...
/**
 * 
 * This class contains response of /rule/get/rules/by/global/rule/id API
 * response
 * 
 * 
 * @author tanvigarg
 *
 */
public class RuleGetRulesByGlobalRuleIdSwagger {
	...
	private List<RuleGetRulesByGlobalRuleId> object;

	/**
	 * @return the object
	 */
	public List<RuleGetRulesByGlobalRuleId> getObject() {
		return object;
	}
	 ...
	 * @param object
	 */
	public void setObject(List<RuleGetRulesByGlobalRuleId> object) {
		this.object = object;
	}
...
/**
 * Set the response parameters of /rule/get/rules/by/global/rule/id API.
 * 
 *
 */

class RuleGetRulesByGlobalRuleId {
