...
/**
 * 
 * This class contains response on /performance/eventstatus/devices/get/all API
 * response
 * 
 * 
 * @author tanvigarg
 *
 */
public class GenericPerformanceEventStatusDevicesGetSwagger {
	...
	private List<GenericPerformanceEventStatusDevicesGet> object;

	/**
	 * @return the object
	 */
	public List<GenericPerformanceEventStatusDevicesGet> getObject() {
		return object;
	}
	 ...
	 * @param object
	 */
	public void setObject(List<GenericPerformanceEventStatusDevicesGet> object) {
		this.object = object;
	}
...
/**
 * Set the response parameters of /performance/eventstatus/devices/get/all API.
 * 
 *
 */
class GenericPerformanceEventStatusDevicesGet {
