...
/**
 * 
 * This class contains response on /inventory/bi/hourly/device/get/all API
 * response
 * 
 * 
 * @author tanvigarg
 *
 */
public class GenericInventoryBiHourlyDeviceGetSwagger {
	...
	private List<GenericInventoryDeviceGet> object;

	/**
	 * @return the object
	 */
	public List<GenericInventoryDeviceGet> getObject() {
		return object;
	}
	 ...
	 * @param object
	 */
	public void setObject(List<GenericInventoryDeviceGet> object) {
		this.object = object;
	}
...
/**
 * Set the response parameters of /inventory/bi/hourly/device/get/all API.
 * 
 *
 */
class GenericInventoryDeviceGet {
