 ...
 * /performance/performanceevent/alert/device/get/all API response
 * 
 * 
 * @author tanvigarg
 *
 */
public class GenericPerformanceEventDeviceGetSwagger {
	...
	private List<GenericPerformanceEventDeviceGet> object;

	/**
	 * @return the object
	 */
	public List<GenericPerformanceEventDeviceGet> getObject() {
		return object;
	}
	 ...
	 * @param object
	 */
	public void setObject(List<GenericPerformanceEventDeviceGet> object) {
		this.object = object;
	}
 ...
 * /performance/performanceevent/alert/device/get/all API.
 * 
 *
 */
class GenericPerformanceEventDeviceGet {
	...
	private String severity_priority;
	...
	/**
	 * @return the severity_priority
	 */
	public String getSeverity_priority() {
		return severity_priority;
	}

	/**
	 * @param severity_priority
	 *            the severity_priority to set
	 */
	public void setSeverity_priority(String severity_priority) {
		this.severity_priority = severity_priority;
	}
