 ...
 * /service/bi/hourly/device/get/all/limit/without/data API response
 * 
 * 
 * @author tanvigarg
 *
 */
public class GenericServiceBiHourlyDeviceGetAllWithoutDataSwagger {
	...
	private List<GenericServiceBiHourlyDeviceGetAllWithoutData> object;

	/**
	 * @return the object
	 */
	public List<GenericServiceBiHourlyDeviceGetAllWithoutData> getObject() {
		return object;
	}
	 ...
	 * @param object
	 */
	public void setObject(List<GenericServiceBiHourlyDeviceGetAllWithoutData> object) {
		this.object = object;
	}
 ...
 * /service/bi/hourly/device/get/all/limit/without/data API.
 * 
 *
 */
class GenericServiceBiHourlyDeviceGetAllWithoutData {
