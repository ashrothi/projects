 ...
 * /performance/event/alert/device/get/single/limit API response
 * 
 * 
 * @author tanvigarg
 *
 */
public class GenericPerformanceEventAlertDeviceGetSwagger {
	...
	private List<GenericPerformanceEventAlertDeviceGet> object;

	/**
	 * @return the object
	 */
	public List<GenericPerformanceEventAlertDeviceGet> getObject() {
		return object;
	}
	 ...
	 * @param object
	 */
	public void setObject(List<GenericPerformanceEventAlertDeviceGet> object) {
		this.object = object;
	}
 ...
 * /performance/event/alert/device/get/single/limit API.
 * 
 *
 */
class GenericPerformanceEventAlertDeviceGet {
