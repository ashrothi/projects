...
/**
 * 
 * This class contains response on /performance/eventstatus/device/type/get/all
 * API response
 * 
 * 
 * @author tanvigarg
 *
 */
public class GenericPerformanceEventStatusAlertDeviceTypeGetAllSwagger {
	...
	private List<GenericPerformanceEventStatusAlertDeviceTypeGetAll> object;

	/**
	 * @return the object
	 */
	public List<GenericPerformanceEventStatusAlertDeviceTypeGetAll> getObject() {
		return object;
	}
	 ...
	 * @param object
	 */
	public void setObject(List<GenericPerformanceEventStatusAlertDeviceTypeGetAll> object) {
		this.object = object;
	}
...
/**
 * Set the response parameters of /performance/eventstatus/device/type/get/all
 * API.
 * 
 *
 */
class GenericPerformanceEventStatusAlertDeviceTypeGetAll {
