...
/**
 * 
 * This class contains response on /device/search API response
 * 
 * 
 * @author tanvigarg
 *
 */
public class DeviceSearchSwagger {
	...
	private List<DeviceSearch> object;

	/**
	 * @return the object
	 */
	public List<DeviceSearch> getObject() {
		return object;
	}
	 ...
	 * @param object
	 */
	public void setObject(List<DeviceSearch> object) {
		this.object = object;
	}
...
/**
 * Set the response parameters of /device/search API.
 * 
 *
 */
class DeviceSearch {
