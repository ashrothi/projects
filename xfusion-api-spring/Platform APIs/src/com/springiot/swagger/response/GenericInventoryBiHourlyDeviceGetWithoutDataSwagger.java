 ...
 * /inventory/bi/hourly/device/get/all/limit/without/data API response
 * 
 * 
 * @author tanvigarg
 *
 */
public class GenericInventoryBiHourlyDeviceGetWithoutDataSwagger {
	...
	private List<GenericInventoryBiHourlyDeviceGetWithoutData> object;

	/**
	 * @return the object
	 */
	public List<GenericInventoryBiHourlyDeviceGetWithoutData> getObject() {
		return object;
	}
	 ...
	 * @param object
	 */
	public void setObject(List<GenericInventoryBiHourlyDeviceGetWithoutData> object) {
		this.object = object;
	}
 ...
 * /inventory/bi/hourly/device/get/all/limit/without/data API.
 * 
 *
 */
class GenericInventoryBiHourlyDeviceGetWithoutData {
