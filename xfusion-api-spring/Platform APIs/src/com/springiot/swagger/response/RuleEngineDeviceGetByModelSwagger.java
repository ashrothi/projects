...
/**
 * 
 * This class contains response on /rule/engine/device/get/by/model API response
 * 
 * 
 * @author tanvigarg
 *
 */
public class RuleEngineDeviceGetByModelSwagger {
	...
	private List<RuleEngineDeviceGetByModel> object;

	/**
	 * @return the object
	 */
	public List<RuleEngineDeviceGetByModel> getObject() {
		return object;
	}
	 ...
	 * @param object
	 */
	public void setObject(List<RuleEngineDeviceGetByModel> object) {
		this.object = object;
	}
...
/**
 * Set the response parameters of /rule/engine/device/get/by/model API.
 * 
 *
 */
class RuleEngineDeviceGetByModel {
