...
/**
 * 
 * This class contains response on /device/get/metadata/status/by/status API
 * response
 * 
 * 
 * @author tanvigarg
 *
 */
public class DeviceGetMetadataStatusByStatusSwagger {
	...
	private List<DeviceGetMetadataStatusByStatus> object;

	/**
	 * @return the object
	 */
	public List<DeviceGetMetadataStatusByStatus> getObject() {
		return object;
	}
	 ...
	 * @param object
	 */
	public void setObject(List<DeviceGetMetadataStatusByStatus> object) {
		this.object = object;
	}
...
/**
 * Set the response parameters of /device/get/metadata/status/by/status API.
 * 
 *
 */
class DeviceGetMetadataStatusByStatus {
	...
	private String device_devicestatus_name;
	...
	/**
	 * @return the device_devicestatus_alias
	 */
	public String getDevice_devicestatus_alias() {
		return device_devicestatus_alias;
	}

	/**
	 * @param device_devicestatus_alias
	 *            the device_devicestatus_alias to set
	 */
	public void setDevice_devicestatus_alias(String device_devicestatus_alias) {
		this.device_devicestatus_alias = device_devicestatus_alias;
	}
	...
	/**
	 * @return the device_devicestatus_colour
	 */
	public String getDevice_devicestatus_colour() {
		return device_devicestatus_colour;
	}

	/**
	 * @param device_devicestatus_colour
	 *            the device_devicestatus_colour to set
	 */
	public void setDevice_devicestatus_colour(String device_devicestatus_colour) {
		this.device_devicestatus_colour = device_devicestatus_colour;
	}
	...
	/**
	 * @return the device_devicestatus_name
	 */
	public String getDevice_devicestatus_name() {
		return device_devicestatus_name;
	}

	/**
	 * @param device_devicestatus_name
	 *            the device_devicestatus_name to set
	 */
	public void setDevice_devicestatus_name(String device_devicestatus_name) {
		this.device_devicestatus_name = device_devicestatus_name;
	}
