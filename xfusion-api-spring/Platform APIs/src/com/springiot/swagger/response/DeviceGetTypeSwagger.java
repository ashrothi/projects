...
/**
 * 
 * This class contains response on /device/get/type API response
 * 
 * 
 * @author tanvigarg
 *
 */
public class DeviceGetTypeSwagger {
	...
	private List<DeviceGetType> object;

	/**
	 * @return the object
	 */
	public List<DeviceGetType> getObject() {
		return object;
	}
	 ...
	 * @param object
	 */
	public void setObject(List<DeviceGetType> object) {
		this.object = object;
	}
...
/**
 * Set the response parameters of /device/get/type API.
 * 
 *
 */
class DeviceGetType {
