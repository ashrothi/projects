...
/**
 * 
 * This class contains response on /device/get/metadata/status/by/type API
 * response
 * 
 * 
 * @author tanvigarg
 *
 */
public class DeviceGetMetadataStatusByTypeSwagger {
	...
	private List<DeviceGetMetadataStatusByType> object;

	/**
	 * @return the object
	 */
	public List<DeviceGetMetadataStatusByType> getObject() {
		return object;
	}
	 ...
	 * @param object
	 */
	public void setObject(List<DeviceGetMetadataStatusByType> object) {
		this.object = object;
	}
...
/**
 * Set the response parameters of /device/get/metadata/status/by/type API.
 * 
 *
 */
class DeviceGetMetadataStatusByType {
	// Initializing the variables
	private Float device_device_longitude;
	private String city_name;
	private Integer device_devicetype_id;
	private Long device_device_creation_date;
	...
	private Integer device_device_elevation;
	 ...
	 */
	public Long getDevice_device_creation_date() {
	 ...
	 */
	public void setDevice_device_creation_date(Long device_device_creation_date) {
	 ...
	 */
	public Integer getDevice_device_elevation() {
	 ...
	 */
	public void setDevice_device_elevation(Integer device_device_elevation) {
