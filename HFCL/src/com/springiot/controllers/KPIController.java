...
public class KPIController {
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "token", value = "Token is generated to authenticate the device"),
		@ApiImplicitParam(name = "report_name", value = "specific Name"),
		@ApiImplicitParam(name = "report_date", value = "specific time interval you want data"),
		@ApiImplicitParam(name = "tag", value = "specific tag type"),
		@ApiImplicitParam(name = "device_id", value = "specific device_id")})
	@RequestMapping(value = "/download/kpi", method = RequestMethod.POST)

	public @ResponseBody Message downloadKPIData(@ApiIgnore @RequestParam Map<String, String> map,
			HttpServletRequest request, HttpServletResponse response) {
		/*
		 * Method GenericProcedureCalling() is called upon to get the data from
		 * respective database.
		 */
		return kpiServices.downloadKPIData(map, request, response);
	}

	@ApiImplicitParams({ 
		@ApiImplicitParam(name = "token", value = "Token is generated to authenticate the device"),
		@ApiImplicitParam(name = "report_name", value = "specific Name"),
		@ApiImplicitParam(name = "start_date", value = "specific start_date interval you want data"),
		@ApiImplicitParam(name = "end_date", value = "specific end_date interval you want data"),
		@ApiImplicitParam(name = "interval_type", value = "specific interval_type interval you want data"),
		@ApiImplicitParam(name = "tag", value = "specific tag type"),
		@ApiImplicitParam(name = "device_id", value = "specific device_id")})
	@RequestMapping(value = "/download/interval/kpi", method = RequestMethod.POST)
	
	public @ResponseBody Message downloadKPIDataForInsterval(@ApiIgnore @RequestParam Map<String, String> map,
			HttpServletRequest request, HttpServletResponse response) {
		/*
		 * Method GenericProcedureCalling() is called upon to get the data from
		 * respective database.
		 */
		return  kpiServices.downloadKPIDataForInterval(map, request, response);
	}
}
