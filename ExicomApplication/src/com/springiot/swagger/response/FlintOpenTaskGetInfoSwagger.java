...
/**
 * 
 * This class contains response on /flint/open/task/get/info API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FlintOpenTaskGetInfoSwagger {
...
/**
	...
	private List<FlintOpenTaskGetInfo> object;

	/**
	 * @return the object
	 */
	public List<FlintOpenTaskGetInfo> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FlintOpenTaskGetInfo> object) {
		this.object = object;
	}
