...
/**
 * 
 * This class contains response on /flint/open/ticket/get/info API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FlintOpenTicketGetInfoSwagger {
...
/**
	...
	private List<FlintOpenTicketGetInfo> object;

	/**
	 * @return the object
	 */
	public List<FlintOpenTicketGetInfo> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FlintOpenTicketGetInfo> object) {
		this.object = object;
	}
