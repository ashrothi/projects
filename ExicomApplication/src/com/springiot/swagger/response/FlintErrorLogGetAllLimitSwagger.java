...
/**
 * 
 * This class contains response on /flint/error/log/get/all/limit API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FlintErrorLogGetAllLimitSwagger {
...
/**
	...
	private List<FlintErrorLogGetAllLimit> object;

	/**
	 * @return the object
	 */
	public List<FlintErrorLogGetAllLimit> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FlintErrorLogGetAllLimit> object) {
		this.object = object;
	}
...
*/
class FlintErrorLogGetAllLimit {
	...
	/**
	 * @param log_exception_id the log_exception_id to set
	 */
	...
	/**
	 * @param log_exception_controller_url the log_exception_controller_url to set
	 */
	...
	/**
	 * @param log_exception_input_parameter the log_exception_input_parameter to set
	 */
	...
	/**
	 * @param log_exception_output the log_exception_output to set
	 */
	...
	/**
	 * @param log_exception_exception the log_exception_exception to set
	 */
	...
	/**
	 * @param log_exception_user_id the log_exception_user_id to set
	 */
	...
	/**
	 * @param log_exception_userKey the log_exception_userKey to set
	 */
	...
	/**
	 * @param log_exception_application_id the log_exception_application_id to set
	 */
	...
	/**
	 * @param log_exception_createdAT the log_exception_createdAT to set
	 */
