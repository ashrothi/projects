...
/**
 * 
 * This class contains response on /flint/vehicle/get/all/criteria API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FlintVehicleGetAllCriteriaSwagger {
...
/**
	...
	private List<FlintVehicleGetAllCriteria> object;

	/**
	 * @return the object
	 */
	public List<FlintVehicleGetAllCriteria> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FlintVehicleGetAllCriteria> object) {
		this.object = object;
	}
...
*/
class FlintVehicleGetAllCriteria {
