...
public class AuditController {
	 ...
	 * @throws Exception 
	 */
	@ApiOperation(value = "/flint/audit/log/get/all", notes = "Returns all the logs for the specific application", response = FlintAuditLogGetAllSwagger.class)
	@ApiImplicitParams({
	...
	@RequestMapping(value = "/flint/audit/log/get/all", method = RequestMethod.POST)
	 ...
	 * @throws Exception 
	 */
	@ApiOperation(value = "/flint/audit/log/insert", notes = "Helps to insert logs of the user for the particular application", response = FlintAuditLogInsertSwagger.class)
	@ApiImplicitParams({
			@ApiImplicitParam(name = "token", value = "Token is generated to access API", required = true, access = "query", paramType = "query"),
			@ApiImplicitParam(name = "user_key", value = "Requires the user_key of User", required = true, access = "query", paramType = "query"),
			@ApiImplicitParam(name = "user_id", value = "Requires User Id of user", required = true, access = "query", paramType = "query"),
	...
	@RequestMapping(value = "/flint/audit/log/insert", method = RequestMethod.POST)
	 ...
	 * @throws Exception 
	 */
	@ApiOperation(value = "/flint/audit/log/get/all/limit", notes = "To get all the audit logs with limit.", response = FlintAuditLogGetAllLimitSwagger.class)
	@ApiImplicitParams({
			@ApiImplicitParam(name = "token", value = "Token is generated to access API", required = true, access = "query", paramType = "query"),
			@ApiImplicitParam(name = "user_key", value = "Requires the user_key of User", required = true, access = "query", paramType = "query"),
			@ApiImplicitParam(name = "user_id", value = "Requires User Id of user", required = true, access = "query", paramType = "query"),
	...
	@RequestMapping(value = "/flint/audit/log/get/all/limit", method = RequestMethod.POST)
	 ...
	 * @throws Exception 
	 */
	@ApiOperation(value = "/flint/audit/log/count", notes = "Helps to get Count of logs for the user of there particular application", response = FlintAuditLogCountSwagger.class)
	@ApiImplicitParams({
			@ApiImplicitParam(name = "token", value = "Token is generated to access API", required = true, access = "query", paramType = "query"),
			@ApiImplicitParam(name = "user_key", value = "Requires the user_key of User", required = true, access = "query", paramType = "query"),
			@ApiImplicitParam(name = "user_id", value = "Requires User Id of user", required = true, access = "query", paramType = "query"),
	...
	@RequestMapping(value = "/flint/audit/log/count", method = RequestMethod.POST)
	...
	/**
	 * To get all the error logs with limit.
	 * 
	 * @param map::::Contains
	 *            all the parameters.
	 * 
	 ...
	 * @throws Exception
	 */
	@ApiOperation(value = "/flint/error/log/get/all/limit", notes = "To get all the audit logs with limit.", response = FlintErrorLogGetAllLimitSwagger.class)
	@ApiImplicitParams({
			@ApiImplicitParam(name = "token", value = "Token is generated to access API", required = true, access = "query", paramType = "query"),
			@ApiImplicitParam(name = "user_key", value = "Requires the user_key of User", required = true, access = "query", paramType = "query"),
			@ApiImplicitParam(name = "user_id", value = "Requires User Id of user", required = true, access = "query", paramType = "query"),
	...
	@RequestMapping(value = "/flint/error/log/get/all/limit", method = RequestMethod.POST)
	public @ResponseBody Message errorLogGetAllLimit(@ApiIgnore @RequestParam Map<String, String> map,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	/**
	 * To get count of error logs for the user of there particular application.
	 * 
	 * @param map::::Contains
	 *            all the parameters.
	 * 
	 ...
	 * @throws Exception
	 */
	@ApiOperation(value = "/flint/error/log/count", notes = "Helps to get Count of logs for the user of there particular application", response = FlintErrorLogCountSwagger.class)
	@ApiImplicitParams({
			@ApiImplicitParam(name = "token", value = "Token is generated to access API", required = true, access = "query", paramType = "query"),
			@ApiImplicitParam(name = "user_key", value = "Requires the user_key of User", required = true, access = "query", paramType = "query"),
			@ApiImplicitParam(name = "user_id", value = "Requires User Id of user", required = true, access = "query", paramType = "query"),
	...
	@RequestMapping(value = "/flint/error/log/count", method = RequestMethod.POST)
	public @ResponseBody Message errorLogCount(@ApiIgnore @RequestParam Map<String, String> map,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
