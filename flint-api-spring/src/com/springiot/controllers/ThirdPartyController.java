...
public class ThirdPartyController {
	 ...
	 * @throws Exception 
	 */
	@ApiOperation(value = "/flint/contact/us/email", notes = "To dend contact us email",response=FlintGetProductVehicleStateSwagger.class)
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = "contact_number", value = "Requires contact_number of user", required = true, access = "query", paramType = "query", dataType = "String"),
		@ApiImplicitParam(name = "query", value = "Requires query of customer", required = true, access = "query", paramType = "query", dataType = "String"),
	})
	/*
	 * Input Parameters are map,request and response.Map handles all
	 * manipulation in data received from procedure
	...
	public @ResponseBody Message contactUsEmail(@ApiIgnore @RequestParam Map<String, String> map,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
		return thirdPartyServices.contactUsEmail( map, null, request, response);
	}
}
