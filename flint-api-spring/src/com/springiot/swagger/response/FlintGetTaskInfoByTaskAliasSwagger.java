...
/**
 * 
 * This class contains response on /flint/get/task/info/by/task/alias API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FlintGetTaskInfoByTaskAliasSwagger {
...
/**
	...
	private List<FlintGetTaskInfoByTaskAlias> object;

	/**
	 * @return the object
	 */
	public List<FlintGetTaskInfoByTaskAlias> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FlintGetTaskInfoByTaskAlias> object) {
		this.object = object;
	}
...
*/
class FlintGetTaskInfoByTaskAlias {
	...
	private String ticket_task_state;
	/**
	...
	/**
	 * @return the ticket_task_state
	 */
	public String getTicket_task_state() {
		return ticket_task_state;
	}
	/**
	 * @param ticket_task_state the ticket_task_state to set
	 */
	public void setTicket_task_state(String ticket_task_state) {
		this.ticket_task_state = ticket_task_state;
	}
