...
/**
 * 
 * This class contains response on /flint/open/ticket/update API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FlintOpenTicketUpdateSwagger {
...
/**
	...
	private List<FlintOpenTicketUpdate> object;

	/**
	 * @return the object
	 */
	public List<FlintOpenTicketUpdate> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FlintOpenTicketUpdate> object) {
		this.object = object;
	}
