...
/**
 * 
 * This class contains response on /flint/open/tickets/get/all API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FlintOpenTicketsGetAllSwagger {
...
/**
	...
	private List<FlintOpenTicketsGetAll> object;

	/**
	 * @return the object
	 */
	public List<FlintOpenTicketsGetAll> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FlintOpenTicketsGetAll> object) {
		this.object = object;
	}
