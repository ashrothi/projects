...
/**
 * 
 * This class contains response on /flint/close/tickets/get/all/mobile API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FlintCloseTicketsGetAllMobileSwagger {
...
/**
	...
	private List<FlintCloseTicketsGetAllMobile> object;

	/**
	 * @return the object
	 */
	public List<FlintCloseTicketsGetAllMobile> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FlintCloseTicketsGetAllMobile> object) {
		this.object = object;
	}
...
*/
class FlintCloseTicketsGetAllMobile {
