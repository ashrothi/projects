...
/**
 * 
 * This class contains response on /flint/history/tracking/get/all API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FlintHistoryTrackingGetAllSwagger {
	...
	private List<FlintHistoryTrackingGetAll> object;

	/**
	 * @return the object
	 */
	public List<FlintHistoryTrackingGetAll> getObject() {
		return object;
	}
	 ...
	 * @param object
	 */
	public void setObject(List<FlintHistoryTrackingGetAll> object) {
		this.object = object;
	}
 ...
 */
class FlintHistoryTrackingGetAll {
