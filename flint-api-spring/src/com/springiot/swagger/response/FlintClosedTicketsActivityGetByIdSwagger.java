...
/**
 * 
 * This class contains response on /flint/closed/tickets/activity/get/by/id API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FlintClosedTicketsActivityGetByIdSwagger {
...
/**
	...
	private List<FlintClosedTicketsActivityGetById> object;

	/**
	 * @return the object
	 */
	public List<FlintClosedTicketsActivityGetById> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FlintClosedTicketsActivityGetById> object) {
		this.object = object;
	}
...
*/
class FlintClosedTicketsActivityGetById {
