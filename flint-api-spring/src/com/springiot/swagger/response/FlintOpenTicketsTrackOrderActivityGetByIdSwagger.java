...
/**
 * 
 * This class contains response on /flint/open/tickets/track/order/activity/get/by/id API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FlintOpenTicketsTrackOrderActivityGetByIdSwagger {
...
/**
	...
	private List<FlintOpenTicketsTrackOrderActivityGetById> object;

	/**
	 * @return the object
	 */
	public List<FlintOpenTicketsTrackOrderActivityGetById> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FlintOpenTicketsTrackOrderActivityGetById> object) {
		this.object = object;
	}
...
*/
class FlintOpenTicketsTrackOrderActivityGetById {
