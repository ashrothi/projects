...
public class MappingHandler {
	...
	@ApiImplicitParams({
			...
			@ApiImplicitParam(name = "file_path", value = "Requires the file path", required = true, access = "query", paramType = "query", dataType = "String"),
			@ApiImplicitParam(name = "auth_mapping", value = "Requires the Auth Mapping", required = true, access = "query", paramType = "query", dataType = "String") })
