...
public class XfusionAuditLogGetAllSwagger {
private String description;
public String getDescription() {return description;}
public void setDescription(String description) {this.description = description;}
private List<XfusionAuditLogGetAll> object;
public List<XfusionAuditLogGetAll> getObject() {return object;}
public void setObject(List<XfusionAuditLogGetAll> object) {this.object = object;}
private boolean valid;
public boolean isValid() {return valid;}
public void setValid(boolean valid) {this.valid = valid;}
}
class XfusionAuditLogGetAll{
private Integer id;
