...
public class Constant {
	...
	public static Map<String, Object> organizationId = new HashMap<>();
	 ...
	 * @param object
	 */
	public static void addOrganizationId(String Token, Object object) {

		organizationId.put(Token, object);
	}
