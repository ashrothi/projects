...
public class SignupController {
	 ...
	 * @throws Exception
	 */
	@ApiOperation(value = "/check/organization", notes = "To check if an organization exists in both Platform and ThirdParty.", response = OauthTokenSwagger.class)
	@ApiImplicitParams({
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = "root_application_id", value = "Here pass the applicarion id.", required = true, access = "query", paramType = "query", dataType = "String"),
		...
		@ApiImplicitParam(name = "insert_user_key", value = "Here pass the user_key for mapping with organization.", required = true, access = "query", paramType = "query", dataType = "String"),
		@ApiImplicitParam(name = "insert_user_id", value = "Here pass the user_id for mapping with organization.", required = true, access = "query", paramType = "query", dataType = "String"),
		@ApiImplicitParam(name = "organization_ids", value = "Here pass the organization ids for mapping with this organization.", required = true, access = "query", paramType = "query", dataType = "String"),
		@ApiImplicitParam(name = "access_key", value = "Here pass the access key for the passed user_id for mapping with organization.", required = true, access = "query", paramType = "query", dataType = "String"),
