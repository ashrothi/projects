...
public class GenericController {
	 ...
	 * @throws Exception
	 */
	@ApiOperation(value = "/state/get/by/country", notes = "To get the state by country id.")
	@ApiImplicitParams({
	...
	@ApiOperation(value = "/get/country", notes = "To get the country.")
	@ApiImplicitParams({
			@ApiImplicitParam(name = "token", value = "Token is generated to access API", required = true, access = "header", paramType = "header", dataType = "String"),
			 })
	...
	@ApiOperation(value = "/city/get/by/state", notes = "To get the city by state id.")
	@ApiImplicitParams({
			@ApiImplicitParam(name = "token", value = "Token is generated to access API", required = true, access = "header", paramType = "header", dataType = "String"),
