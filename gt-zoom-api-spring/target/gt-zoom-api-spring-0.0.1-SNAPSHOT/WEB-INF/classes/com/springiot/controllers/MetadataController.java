...
public class MetadataController {
	 ...
	 * @throws Exception
	 */
	@ApiOperation(value = "/units/get/all", notes = "To get all the units.")
	@ApiImplicitParams({
	 ...
	 * @throws Exception
	 */
	@ApiOperation(value = "vehicle/manufacturers/get/all", notes = "To get all the vehicle manufactures names.")
	@ApiImplicitParams({
			@ApiImplicitParam(name = "token", value = "Token is generated to access API", required = true, access = "header", paramType = "header", dataType = "String"),
			 })
	 ...
	 * @throws Exception
	 */
	@ApiOperation(value = "/vehicle/status/get/all", notes = "To get status of all the vehicles.")
	@ApiImplicitParams({
			@ApiImplicitParam(name = "token", value = "Token is generated to access API", required = true, access = "header", paramType = "header", dataType = "String"),
			 })
	 ...
	 * @throws Exception
	 */
	@ApiOperation(value = "/vehicle/types/get/all", notes = "To get all the vehicle types.")
	@ApiImplicitParams({
			@ApiImplicitParam(name = "token", value = "Token is generated to access API", required = true, access = "header", paramType = "header", dataType = "String"),
			 })
	 ...
	 * @throws Exception
	 */
	@ApiOperation(value = "/fueltypes/get/all", notes = "To get all the fuel types.")
	@ApiImplicitParams({
			@ApiImplicitParam(name = "token", value = "Token is generated to access API", required = true, access = "header", paramType = "header", dataType = "String"),
			 })
	 ...
	 * @throws Exception
	 */
	@ApiOperation(value = "/currency/get/all", notes = "To get all the currencies.")
	@ApiImplicitParams({
			@ApiImplicitParam(name = "token", value = "Token is generated to access API", required = true, access = "header", paramType = "header", dataType = "String"),
			 })
