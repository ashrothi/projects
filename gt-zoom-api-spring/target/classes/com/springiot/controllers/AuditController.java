...
public class AuditController {
	 ...
	 * @throws Exception
	 */
	@ApiOperation(value = "/gtzoom/audit/log/count", notes = "Helps to get Count of logs for the user of there particular application", response = GtzoomAuditLogCountSwagger.class)
	@ApiImplicitParams({
	 ...
	 * @throws Exception
	 */
	@ApiOperation(value = "/gtzoom/audit/log/get/all", notes = "Returns all the logs for the specific application", response = GtzoomAuditLogGetAllSwagger.class)
	@ApiImplicitParams({
			@ApiImplicitParam(name = "token", value = "Token is generated to access API", required = true, access = "header", paramType = "header"),
			@ApiImplicitParam(name = "user_key", value = "Requires User Key of user", required = true, access = "header", paramType = "header", dataType = "String"),
			@ApiImplicitParam(name = "user_id", value = "Requires User Id of user", required = true, access = "header", paramType = "header", dataType = "String"),
	 ...
	 * @throws Exception
	 */
	@ApiOperation(value = "/gtzoom/audit/log/get/all/limit", notes = "To get all the audit logs with limit.", response = GtzoomAuditLogGetAllLimitSwagger.class)
	@ApiImplicitParams({
			@ApiImplicitParam(name = "token", value = "Token is generated to access API", required = true, access = "header", paramType = "header"),
			@ApiImplicitParam(name = "user_key", value = "Requires User Key of user", required = true, access = "header", paramType = "header", dataType = "String"),
			@ApiImplicitParam(name = "user_id", value = "Requires User Id of user", required = true, access = "header", paramType = "header", dataType = "String"),
	 ...
	 * @throws Exception
	 */
	@ApiOperation(value = "/gtzoom/audit/log/insert", notes = "Helps to insert logs of the user for the particular application", response = GtzoomAuditLogInsertSwagger.class)
	@ApiImplicitParams({
			@ApiImplicitParam(name = "token", value = "Token is generated to access API", required = true, access = "header", paramType = "header"),
			@ApiImplicitParam(name = "user_key", value = "Requires User Key of user", required = true, access = "header", paramType = "header", dataType = "String"),
			@ApiImplicitParam(name = "user_id", value = "Requires User Id of user", required = true, access = "header", paramType = "header", dataType = "String"),
