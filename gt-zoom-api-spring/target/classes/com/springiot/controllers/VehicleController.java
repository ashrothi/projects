...
import com.springiot.swagger.response.GetDeviceDetailsByVehicleIdSwagger;
import com.springiot.swagger.response.PerformanceStatusDeviceGetAllSwagger;
import com.springiot.swagger.response.VehicleGetAllByDeviceTypeSwagger;
import com.springiot.swagger.response.VehicleGetAllSwagger;
...
public class VehicleController {
	 ...
	 * @throws Exception
	 */
	@ApiOperation(value = "/vehicle/get/all", notes = "To get all the vehicle.", response = VehicleGetAllSwagger.class)
	@ApiImplicitParams({
	 ...
	 * @throws Exception
	 */
	@ApiOperation(value = "/vehicle/get/all/by/device/type", notes = "To get all the vehicle on the basis of device type.", response = VehicleGetAllByDeviceTypeSwagger.class)
	@ApiImplicitParams({
			@ApiImplicitParam(name = "token", value = "Token is generated to access API", required = true, access = "header", paramType = "header", dataType = "String"),
			@ApiImplicitParam(name = "user_key", value = "Requires User Key of user", required = true, access = "header", paramType = "header", dataType = "String"),
	 ...
	 * @throws Exception
	 */
	@ApiOperation(value = "/get/device/details/by/vehicle/id", notes = "To get the device details by vehicle id.", response = GetDeviceDetailsByVehicleIdSwagger.class)
	@ApiImplicitParams({
			@ApiImplicitParam(name = "token", value = "Token is generated to access API", required = true, access = "header", paramType = "header", dataType = "String"),
			@ApiImplicitParam(name = "user_key", value = "Requires User Key of user", required = true, access = "header", paramType = "header", dataType = "String"),
			@ApiImplicitParam(name = "user_id", value = "Requires user id of user", required = true, access = "header", paramType = "header", dataType = "String"),
	 ...
	 * @throws Exception
	 */
	@ApiOperation(value = "/performance/status/device/get/all", notes = "Get all parameters from Status table", response = PerformanceStatusDeviceGetAllSwagger.class)
	 ...
	 * @throws Exception
	 */
	@ApiOperation(value = "/get/vehicle/details/by/vehicle/id", notes = "To get the vehicle details by vehicle id.", response = VehicleGetAllByDeviceTypeSwagger.class)
	@ApiImplicitParams({
			@ApiImplicitParam(name = "token", value = "Token is generated to access API", required = true, access = "header", paramType = "header", dataType = "String"),
			@ApiImplicitParam(name = "user_key", value = "Requires User Key of user", required = true, access = "header", paramType = "header", dataType = "String"),
			@ApiImplicitParam(name = "user_id", value = "Requires user id of user", required = true, access = "header", paramType = "header", dataType = "String"),
