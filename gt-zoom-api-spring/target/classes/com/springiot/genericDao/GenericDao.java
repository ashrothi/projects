...
public class GenericDao {
	...
	/**
	 * executeUpdateSqlQuery() method used to execute any sql query in database using executeUpdate method.
	 * 
	 * @param sql : Here pass the sql query as string.
	 * @return results : returns the response from the sql query.
	 */
