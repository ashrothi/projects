...
/**
 * 
 * This class contains response on /flint/audit/log/get/all/limit API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class GtzoomAuditLogGetAllLimitSwagger {
...
/**
	...
	private List<FlintAuditLogGetAllLimit> object;

	/**
	 * @return the object
	 */
	public List<FlintAuditLogGetAllLimit> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FlintAuditLogGetAllLimit> object) {
		this.object = object;
	}
...
*/
class FlintAuditLogGetAllLimit {
	private Integer id;
