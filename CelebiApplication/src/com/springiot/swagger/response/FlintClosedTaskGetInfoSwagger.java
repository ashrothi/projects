...
/**
 * 
 * This class contains response on /flint/closed/task/get/info API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FlintClosedTaskGetInfoSwagger {
...
/**
	...
	private List<FlintClosedTaskGetInfo> object;

	/**
	 * @return the object
	 */
	public List<FlintClosedTaskGetInfo> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FlintClosedTaskGetInfo> object) {
		this.object = object;
	}
