...
/**
 * 
 * This class contains response on /flint/open/ticket/insert API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FlintOpenTicketInsertSwagger {
...
/**
	...
	private List<FlintOpenTicketInsert> object;

	/**
	 * @return the object
	 */
	public List<FlintOpenTicketInsert> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FlintOpenTicketInsert> object) {
		this.object = object;
	}
