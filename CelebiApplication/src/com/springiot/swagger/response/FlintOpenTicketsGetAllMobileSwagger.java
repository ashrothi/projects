...
/**
 * 
 * This class contains response on /flint/open/tickets/get/all/mobile API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FlintOpenTicketsGetAllMobileSwagger {
...
/**
	...
	private List<FlintOpenTicketsGetAllMobile> object;

	/**
	 * @return the object
	 */
	public List<FlintOpenTicketsGetAllMobile> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FlintOpenTicketsGetAllMobile> object) {
		this.object = object;
	}
...
*/
class FlintOpenTicketsGetAllMobile {
