...
/**
 * 
 * This class contains response on /flint/vehicle/add/engine API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FlintVehicleAddEngineSwagger {
...
/**
	...
	private List<FlintVehicleAddEngine> object;

	/**
	 * @return the object
	 */
	public List<FlintVehicleAddEngine> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FlintVehicleAddEngine> object) {
		this.object = object;
	}
