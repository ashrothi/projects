...
/**
 * 
 * This class contains response on /flint/closed/ticket/get/info API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FlintClosedTicketGetInfoSwagger {
...
/**
	...
	private List<FlintClosedTicketGetInfo> object;

	/**
	 * @return the object
	 */
	public List<FlintClosedTicketGetInfo> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FlintClosedTicketGetInfo> object) {
		this.object = object;
	}
...
*/
class FlintClosedTicketGetInfo {
