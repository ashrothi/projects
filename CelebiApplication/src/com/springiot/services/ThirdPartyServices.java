...
public class ThirdPartyServices {
	...
	public Message SendEmailContactUs(Map<String, String> map, Object object, HttpServletRequest request,
		...
		try {
			...
			String[] toEmailUser = String.valueOf(map.get("email")).split(",");
			String[] ccEmailUser = String.valueOf(environment.getProperty("mail.smtp.email.cc")).split(",");
			String[] bccEmailUser = String.valueOf(environment.getProperty("mail.smtp.email.cc")).split(",");
			/**
			...
			String responsedata = templateReport.TemplateReportFile("template/Thank-you-Email.vm", map);
			flag = SendEmail.email(String.valueOf(environment.getProperty("mail.smtp.username")),
					...
					String.valueOf(environment.getProperty("mail.smtp.port")), builder, toEmailUser, ccEmailUser,
					bccEmailUser, null, String.valueOf(environment.getProperty("mail.smtp.email.subject.query")),
					responsedata, String.valueOf(environment.getProperty("mail.smtp.email.status")),
					String.valueOf(environment.getProperty("mail.smtp.from")), "ankita.shrothi@teramatrix.in", null);

			String responsedata1 = templateReport.TemplateReportFile("template/admin-chelebi-Email.vm", map);
			String[] toEmail = String.valueOf(environment.getProperty("mail.smtp.email.contact.admin")).split(",");
			String[] ccEmail = String.valueOf(environment.getProperty("mail.smtp.email.cc")).split(",");
			String[] bccEmail = String.valueOf(environment.getProperty("mail.smtp.email.cc")).split(",");
			flag1 = SendEmail.email(String.valueOf(environment.getProperty("mail.smtp.username")),
					String.valueOf(environment.getProperty("mail.smtp.password")),
					String.valueOf(environment.getProperty("mail.socket.port")),
					String.valueOf(environment.getProperty("mail.socket.class")),
					String.valueOf(environment.getProperty("mail.smtp.auth")),
					...
					null, String.valueOf(environment.getProperty("mail.smtp.email.subject.query")), responsedata1,
