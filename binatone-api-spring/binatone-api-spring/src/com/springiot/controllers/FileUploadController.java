...
import com.springiot.swagger.response.UploadFirmwareFileSwagger;
...
public class FileUploadController {
	 ...
	 * @return File Path which is uploaded on server
	 */
	@ApiOperation(value = "/upload/firmware/file", notes = "To Upload File in FTP Server",response=UploadFirmwareFileSwagger.class)
	@ApiImplicitParams({
	...
	public @ResponseBody Message binatoneUploadFirmwareFile(@RequestParam("file") MultipartFile file,
			HttpServletRequest request, HttpServletResponse response) {
		Message message = fileUploadService.binatoneUploadFirmwareFile(file, request);
		return message;
	}
