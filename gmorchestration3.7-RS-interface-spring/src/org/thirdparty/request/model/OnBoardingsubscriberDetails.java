...
public class OnBoardingsubscriberDetails {
	...
	public String toString() {
		return "OnBoardingsubscriberDetails [accountType=" + accountType + ", title=" + title + ", firstName="
				+ firstName + ", lastName=" + lastName + ", preferredLanguageCode=" + preferredLanguageCode
				+ ", address=" + address + ", communication=" + communication + "]";
	}
